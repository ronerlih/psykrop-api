	...
	return (
		...
		<Row>
			...
			<Col size="md-6">
				...
				<P>
					The psyKrop API also reports the relative compositional strength (maximum score: 100) of the image as related to those structural lines (vertical/horizontal/diagonal) that are most dominant (two most dominant scores are reported). For image id [00] {`{`}the cat image{`}`} above, for
				...
				<P>All paid API plans are free of commercial use restrictions. Free API plans may be used in commercial services or products with attribution of "Powered by psyKrop™ " and must also link to this API website.</P>
